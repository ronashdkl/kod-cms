...
use ronashdkl\kodCms\models\OauthClientsSearch;
...
/**
 * OauthClientController implements the CRUD actions for OauthClients model.
 */
class OauthClientController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $model->client_id = uniqid('kodstack-');
        $model->client_secret = uniqid();
            ...
            */
            ...
            if ($request->isGet) {
                ...
                return [
                    ...
                    'title' => "Create new OauthClients",
                    'content' => '<span class="text-success">Create OauthClients success</span>',
                    'footer' => Html::button('Close', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
    ...
    /**
     * Delete an existing OauthClients model.
     * For ajax request will return json object
    ...
    /**
     * Delete multiple existing OauthClients model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param string $id
     * @return mixed
