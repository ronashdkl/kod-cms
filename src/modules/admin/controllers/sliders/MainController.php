...
use ronashdkl\kodCms\modules\admin\models\SliderMainSearch;
...
/**
 * MainController implements the CRUD actions for SliderMain model.
 */
class MainController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new SliderMain",
                    'content'=>'<span class="text-success">Create SliderMain success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing SliderMain model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing SliderMain model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
